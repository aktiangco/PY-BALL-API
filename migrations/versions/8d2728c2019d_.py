...
Revision ID: 8d2728c2019d
Revises: 4a5f4e84c945
Create Date: 2023-05-12 10:55:03.493367
...
revision = '8d2728c2019d'
down_revision = '4a5f4e84c945'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.PrimaryKeyConstraint('id', name='reptile_pkey')
    )
